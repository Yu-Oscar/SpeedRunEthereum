...
const deployedContracts = {
  ...
  11155111: {
    Corn: {
      address: "0x16f4c5beDeFD2605C006ed7Ee7c4DfF856aaC9ED",
      abi: [
        {
          inputs: [],
          stateMutability: "nonpayable",
      ...
      deployedOnBlock: 10280700,
    },
    CornDEX: {
      address: "0xBD3Bb03244CDDb574BEA423Ae44f023Be85dFad8",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 10280701,
    },
    FlashLoanLiquidator: {
      address: "0xaB4917E88a9D4644A06bD177bF3C40f66D1Fd0aD",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 10280704,
    },
    Lending: {
      address: "0x07C17c2df0a8d7b6003B9e1676f497739Af591B3",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 10280702,
    },
    Leverage: {
      address: "0x13Dc656723970ad1aD2360402E10A417105941cd",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 10280705,
    },
    MovePrice: {
      address: "0x9d5A3926f7a7D1bD43D83D722b922e4f17619828",
      abi: [
        {
          inputs: [
            {
